...
(function () {
    ...
    }, o = jsPlumbUtil.log, F = jsPlumbUtil.group, f = jsPlumbUtil.groupEnd, E = jsPlumbUtil.time, t = jsPlumbUtil.timeEnd, p = function () {
    ...
    var w = function (I) {
        ...
        this.setId = function (bD, bz, bF) {
            var bG = bD.constructor == String ? bD : br.getId(bD), bC = br.getConnections({
                source: bG,
                scope: "*"
            }, true), bB = br.getConnections({target: bG, scope: "*"}, true);
            bz = "" + bz;
            if (!bF) {
        ...
        var bs = function (bE, bB) {
            ...
            if (bC != null) {
                var bA = bC.tagName.toLowerCase() === "body" ? {
                    left: 0,
                    top: 0
                } : s(bC, br), bD = bC.tagName.toLowerCase() === "body" ? {left: 0, top: 0} : {
                    left: bC.scrollLeft,
                    top: bC.scrollTop
                };
        ...
        var az = function (bU) {
            ...
            var bD = aj[this.sourceId], bC = ag[this.sourceId], bz = aj[this.targetId], bH = ag[this.targetId], bI = bd || p(), bN = this.endpoints[0].anchor.compute({
                xy: [bD.left, bD.top],
                wh: bC,
            ...
            this.paint = function (cd) {
                if (bB) {
                    ...
                    if (bX == null || bX != bJ) {
                        var cf = X({elId: b4, offset: b5, recalc: b2, timestamp: bX}), b3 = X({
                            elId: cc,
                            timestamp: bX
                        });
...
(function () {
    ...
    jsPlumb.Connectors.Straight = function () {
        ...
        this.pointAlongPathFrom = function (t, x, w) {
            var v = s.pointOnPath(t, w), u = t == 1 ? {x: i + ((e - i) * 10), y: h + ((h - d) * 10)} : x <= 0 ? {
                x: i,
                y: h
            } : {x: e, y: d};
            if (x <= 0 && Math.abs(x) > 1) {
    ...
    jsPlumb.Connectors.Flowchart = function (A) {
        ...
        this.compute = function (aa, ao, D, U, az, O, Y, T, au, aq) {
            ...
            var at = [];
            var W = R[0] == 0 ? "y" : "x", Q = af ? "opposite" : G ? "orthogonal" : "perpendicular", J = jsPlumbUtil.segment([M, L], [aw, av]), ak = R[W == "x" ? 0 : 1] == -1, V = {
                x: [null, 4, 3, 2, 1],
                y: [null, 2, 1, 4, 3]
            };
            if (ak) {
        ...
        this.draw = function (m, s, w) {
            ...
            if (m.pointAlongPathFrom) {
                ...
                var z = {
                    ...
                    tail: t,
                    cxy: k
                }, x = f.strokeStyle || s.strokeStyle, r = f.fillStyle || s.strokeStyle, i = f.lineWidth || s.lineWidth;
                e.paint(m, z, i, x, r, w);
                return [q, p, o, n]
            } else {
                return [0, 0, 0, 0]
    ...
    var t = 1000, s = {}, a = function (u, i) {
        ...
        this.paint = function (A, x, z) {
            if (x != null) {
                ...
                if (x.outlineColor) {
                    var C = x.outlineWidth || 1, D = x.lineWidth + (2 * C), B = {
                        strokeStyle: jsPlumbUtil.convertStyle(x.outlineColor),
                        lineWidth: D
                    };
                    for (var w in h) {
                        B[w] = x[w]
...
(function () {
    ...
    }, w = "stroke-dasharray", A = "dashstyle", e = "linearGradient", b = "radialGradient", c = "fill", a = "stop", z = "stroke", q = "stroke-width", h = "style", m = "none", t = "jsplumb_gradient_", o = "lineWidth", C = {
    ...
    var s = function (H) {
        ...
        var F = H.cssClass + " " + (H.originalArgs[0].cssClass || ""), I = {
            style: "",
            width: 0,
            height: 0,
            "pointer-events": G,
...
(function () {
        ...
        p.paint = function (w, t) {
            if (t != null) {
                ...
                if (t.outlineColor != null) {
                    var v = t.outlineWidth || 1, s = t.lineWidth + (2 * v), u = {
    ...
    var b = function (r) {
        var p = this;
        l.apply(this, arguments);
        var q = p._jsPlumb.endpointClass + " " + (r.cssClass || ""), o = {
            "class": q,
            _jsPlumb: p._jsPlumb,
            parent: r.parent,
            tooltip: p.tooltip
